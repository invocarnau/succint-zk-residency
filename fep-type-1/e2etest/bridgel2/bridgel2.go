...
// Bridgel2MetaData contains all meta data concerning the Bridgel2 contract.
var Bridgel2MetaData = &bind.MetaData{
...
// Bridgel2ABI is the input ABI used to generate the binding from.
// Deprecated: Use Bridgel2MetaData.ABI instead.
var Bridgel2ABI = Bridgel2MetaData.ABI

// Bridgel2Bin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use Bridgel2MetaData.Bin instead.
var Bridgel2Bin = Bridgel2MetaData.Bin

// DeployBridgel2 deploys a new Ethereum contract, binding an instance of Bridgel2 to it.
func DeployBridgel2(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *Bridgel2, error) {
	parsed, err := Bridgel2MetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(Bridgel2Bin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &Bridgel2{Bridgel2Caller: Bridgel2Caller{contract: contract}, Bridgel2Transactor: Bridgel2Transactor{contract: contract}, Bridgel2Filterer: Bridgel2Filterer{contract: contract}}, nil
}

// Bridgel2 is an auto generated Go binding around an Ethereum contract.
type Bridgel2 struct {
	Bridgel2Caller     // Read-only binding to the contract
	Bridgel2Transactor // Write-only binding to the contract
	Bridgel2Filterer   // Log filterer for contract events
}

// Bridgel2Caller is an auto generated read-only Go binding around an Ethereum contract.
type Bridgel2Caller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Bridgel2Transactor is an auto generated write-only Go binding around an Ethereum contract.
type Bridgel2Transactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Bridgel2Filterer is an auto generated log filtering Go binding around an Ethereum contract events.
type Bridgel2Filterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// Bridgel2Session is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type Bridgel2Session struct {
	Contract     *Bridgel2         // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// Bridgel2CallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type Bridgel2CallerSession struct {
	Contract *Bridgel2Caller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts   // Call options to use throughout this session
}

// Bridgel2TransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type Bridgel2TransactorSession struct {
	Contract     *Bridgel2Transactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts   // Transaction auth options to use throughout this session
}

// Bridgel2Raw is an auto generated low-level Go binding around an Ethereum contract.
type Bridgel2Raw struct {
	Contract *Bridgel2 // Generic contract binding to access the raw methods on
}

// Bridgel2CallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type Bridgel2CallerRaw struct {
	Contract *Bridgel2Caller // Generic read-only contract binding to access the raw methods on
}

// Bridgel2TransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type Bridgel2TransactorRaw struct {
	Contract *Bridgel2Transactor // Generic write-only contract binding to access the raw methods on
}

// NewBridgel2 creates a new instance of Bridgel2, bound to a specific deployed contract.
func NewBridgel2(address common.Address, backend bind.ContractBackend) (*Bridgel2, error) {
	contract, err := bindBridgel2(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &Bridgel2{Bridgel2Caller: Bridgel2Caller{contract: contract}, Bridgel2Transactor: Bridgel2Transactor{contract: contract}, Bridgel2Filterer: Bridgel2Filterer{contract: contract}}, nil
}

// NewBridgel2Caller creates a new read-only instance of Bridgel2, bound to a specific deployed contract.
func NewBridgel2Caller(address common.Address, caller bind.ContractCaller) (*Bridgel2Caller, error) {
	contract, err := bindBridgel2(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &Bridgel2Caller{contract: contract}, nil
}

// NewBridgel2Transactor creates a new write-only instance of Bridgel2, bound to a specific deployed contract.
func NewBridgel2Transactor(address common.Address, transactor bind.ContractTransactor) (*Bridgel2Transactor, error) {
	contract, err := bindBridgel2(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &Bridgel2Transactor{contract: contract}, nil
}

// NewBridgel2Filterer creates a new log filterer instance of Bridgel2, bound to a specific deployed contract.
func NewBridgel2Filterer(address common.Address, filterer bind.ContractFilterer) (*Bridgel2Filterer, error) {
	contract, err := bindBridgel2(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &Bridgel2Filterer{contract: contract}, nil
}

// bindBridgel2 binds a generic wrapper to an already deployed contract.
func bindBridgel2(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := Bridgel2MetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
// returns.
func (_Bridgel2 *Bridgel2Raw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Bridgel2.Contract.Bridgel2Caller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Bridgel2 *Bridgel2Raw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Bridgel2.Contract.Bridgel2Transactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_Bridgel2 *Bridgel2Raw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Bridgel2.Contract.Bridgel2Transactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_Bridgel2 *Bridgel2CallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _Bridgel2.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_Bridgel2 *Bridgel2TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Bridgel2.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_Bridgel2 *Bridgel2TransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _Bridgel2.Contract.contract.Transact(opts, method, params...)
}
...
func (_Bridgel2 *Bridgel2Caller) BASEINITBYTECODEWRAPPEDTOKEN(opts *bind.CallOpts) ([]byte, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "BASE_INIT_BYTECODE_WRAPPED_TOKEN")
...
//
// Solidity: function BASE_INIT_BYTECODE_WRAPPED_TOKEN() view returns(bytes)
func (_Bridgel2 *Bridgel2Session) BASEINITBYTECODEWRAPPEDTOKEN() ([]byte, error) {
	return _Bridgel2.Contract.BASEINITBYTECODEWRAPPEDTOKEN(&_Bridgel2.CallOpts)
}

// BASEINITBYTECODEWRAPPEDTOKEN is a free data retrieval call binding the contract method 0x83c43a55.
//
// Solidity: function BASE_INIT_BYTECODE_WRAPPED_TOKEN() view returns(bytes)
func (_Bridgel2 *Bridgel2CallerSession) BASEINITBYTECODEWRAPPEDTOKEN() ([]byte, error) {
	return _Bridgel2.Contract.BASEINITBYTECODEWRAPPEDTOKEN(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) WETHToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "WETHToken")
...
//
// Solidity: function WETHToken() view returns(address)
func (_Bridgel2 *Bridgel2Session) WETHToken() (common.Address, error) {
	return _Bridgel2.Contract.WETHToken(&_Bridgel2.CallOpts)
}

// WETHToken is a free data retrieval call binding the contract method 0x4b2f336d.
//
// Solidity: function WETHToken() view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) WETHToken() (common.Address, error) {
	return _Bridgel2.Contract.WETHToken(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) BridgeManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "bridgeManager")
...
//
// Solidity: function bridgeManager() view returns(address)
func (_Bridgel2 *Bridgel2Session) BridgeManager() (common.Address, error) {
	return _Bridgel2.Contract.BridgeManager(&_Bridgel2.CallOpts)
}

// BridgeManager is a free data retrieval call binding the contract method 0x14cc01a0.
//
// Solidity: function bridgeManager() view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) BridgeManager() (common.Address, error) {
	return _Bridgel2.Contract.BridgeManager(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) CalculateRoot(opts *bind.CallOpts, leafHash [32]byte, smtProof [32][32]byte, index uint32) ([32]byte, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "calculateRoot", leafHash, smtProof, index)
...
//
// Solidity: function calculateRoot(bytes32 leafHash, bytes32[32] smtProof, uint32 index) pure returns(bytes32)
func (_Bridgel2 *Bridgel2Session) CalculateRoot(leafHash [32]byte, smtProof [32][32]byte, index uint32) ([32]byte, error) {
	return _Bridgel2.Contract.CalculateRoot(&_Bridgel2.CallOpts, leafHash, smtProof, index)
}

// CalculateRoot is a free data retrieval call binding the contract method 0x83f24403.
//
// Solidity: function calculateRoot(bytes32 leafHash, bytes32[32] smtProof, uint32 index) pure returns(bytes32)
func (_Bridgel2 *Bridgel2CallerSession) CalculateRoot(leafHash [32]byte, smtProof [32][32]byte, index uint32) ([32]byte, error) {
	return _Bridgel2.Contract.CalculateRoot(&_Bridgel2.CallOpts, leafHash, smtProof, index)
}
...
func (_Bridgel2 *Bridgel2Caller) CalculateTokenWrapperAddress(opts *bind.CallOpts, originNetwork uint32, originTokenAddress common.Address, token common.Address) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "calculateTokenWrapperAddress", originNetwork, originTokenAddress, token)
...
//
// Solidity: function calculateTokenWrapperAddress(uint32 originNetwork, address originTokenAddress, address token) view returns(address)
func (_Bridgel2 *Bridgel2Session) CalculateTokenWrapperAddress(originNetwork uint32, originTokenAddress common.Address, token common.Address) (common.Address, error) {
	return _Bridgel2.Contract.CalculateTokenWrapperAddress(&_Bridgel2.CallOpts, originNetwork, originTokenAddress, token)
}

// CalculateTokenWrapperAddress is a free data retrieval call binding the contract method 0x7843298b.
//
// Solidity: function calculateTokenWrapperAddress(uint32 originNetwork, address originTokenAddress, address token) view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) CalculateTokenWrapperAddress(originNetwork uint32, originTokenAddress common.Address, token common.Address) (common.Address, error) {
	return _Bridgel2.Contract.CalculateTokenWrapperAddress(&_Bridgel2.CallOpts, originNetwork, originTokenAddress, token)
}
...
func (_Bridgel2 *Bridgel2Caller) ClaimedBitMap(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "claimedBitMap", arg0)
...
//
// Solidity: function claimedBitMap(uint256 ) view returns(uint256)
func (_Bridgel2 *Bridgel2Session) ClaimedBitMap(arg0 *big.Int) (*big.Int, error) {
	return _Bridgel2.Contract.ClaimedBitMap(&_Bridgel2.CallOpts, arg0)
}

// ClaimedBitMap is a free data retrieval call binding the contract method 0xee25560b.
//
// Solidity: function claimedBitMap(uint256 ) view returns(uint256)
func (_Bridgel2 *Bridgel2CallerSession) ClaimedBitMap(arg0 *big.Int) (*big.Int, error) {
	return _Bridgel2.Contract.ClaimedBitMap(&_Bridgel2.CallOpts, arg0)
}
...
func (_Bridgel2 *Bridgel2Caller) DepositCount(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "depositCount")
...
//
// Solidity: function depositCount() view returns(uint256)
func (_Bridgel2 *Bridgel2Session) DepositCount() (*big.Int, error) {
	return _Bridgel2.Contract.DepositCount(&_Bridgel2.CallOpts)
}

// DepositCount is a free data retrieval call binding the contract method 0x2dfdf0b5.
//
// Solidity: function depositCount() view returns(uint256)
func (_Bridgel2 *Bridgel2CallerSession) DepositCount() (*big.Int, error) {
	return _Bridgel2.Contract.DepositCount(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) GasTokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "gasTokenAddress")
...
//
// Solidity: function gasTokenAddress() view returns(address)
func (_Bridgel2 *Bridgel2Session) GasTokenAddress() (common.Address, error) {
	return _Bridgel2.Contract.GasTokenAddress(&_Bridgel2.CallOpts)
}

// GasTokenAddress is a free data retrieval call binding the contract method 0x3c351e10.
//
// Solidity: function gasTokenAddress() view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) GasTokenAddress() (common.Address, error) {
	return _Bridgel2.Contract.GasTokenAddress(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) GasTokenMetadata(opts *bind.CallOpts) ([]byte, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "gasTokenMetadata")
...
//
// Solidity: function gasTokenMetadata() view returns(bytes)
func (_Bridgel2 *Bridgel2Session) GasTokenMetadata() ([]byte, error) {
	return _Bridgel2.Contract.GasTokenMetadata(&_Bridgel2.CallOpts)
}

// GasTokenMetadata is a free data retrieval call binding the contract method 0x27aef4e8.
//
// Solidity: function gasTokenMetadata() view returns(bytes)
func (_Bridgel2 *Bridgel2CallerSession) GasTokenMetadata() ([]byte, error) {
	return _Bridgel2.Contract.GasTokenMetadata(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) GasTokenNetwork(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "gasTokenNetwork")
...
//
// Solidity: function gasTokenNetwork() view returns(uint32)
func (_Bridgel2 *Bridgel2Session) GasTokenNetwork() (uint32, error) {
	return _Bridgel2.Contract.GasTokenNetwork(&_Bridgel2.CallOpts)
}

// GasTokenNetwork is a free data retrieval call binding the contract method 0x3cbc795b.
//
// Solidity: function gasTokenNetwork() view returns(uint32)
func (_Bridgel2 *Bridgel2CallerSession) GasTokenNetwork() (uint32, error) {
	return _Bridgel2.Contract.GasTokenNetwork(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) GetLeafValue(opts *bind.CallOpts, leafType uint8, originNetwork uint32, originAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadataHash [32]byte) ([32]byte, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "getLeafValue", leafType, originNetwork, originAddress, destinationNetwork, destinationAddress, amount, metadataHash)
...
//
// Solidity: function getLeafValue(uint8 leafType, uint32 originNetwork, address originAddress, uint32 destinationNetwork, address destinationAddress, uint256 amount, bytes32 metadataHash) pure returns(bytes32)
func (_Bridgel2 *Bridgel2Session) GetLeafValue(leafType uint8, originNetwork uint32, originAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadataHash [32]byte) ([32]byte, error) {
	return _Bridgel2.Contract.GetLeafValue(&_Bridgel2.CallOpts, leafType, originNetwork, originAddress, destinationNetwork, destinationAddress, amount, metadataHash)
}

// GetLeafValue is a free data retrieval call binding the contract method 0x3e197043.
//
// Solidity: function getLeafValue(uint8 leafType, uint32 originNetwork, address originAddress, uint32 destinationNetwork, address destinationAddress, uint256 amount, bytes32 metadataHash) pure returns(bytes32)
func (_Bridgel2 *Bridgel2CallerSession) GetLeafValue(leafType uint8, originNetwork uint32, originAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadataHash [32]byte) ([32]byte, error) {
	return _Bridgel2.Contract.GetLeafValue(&_Bridgel2.CallOpts, leafType, originNetwork, originAddress, destinationNetwork, destinationAddress, amount, metadataHash)
}
...
func (_Bridgel2 *Bridgel2Caller) GetRoot(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "getRoot")
...
//
// Solidity: function getRoot() view returns(bytes32)
func (_Bridgel2 *Bridgel2Session) GetRoot() ([32]byte, error) {
	return _Bridgel2.Contract.GetRoot(&_Bridgel2.CallOpts)
}

// GetRoot is a free data retrieval call binding the contract method 0x5ca1e165.
//
// Solidity: function getRoot() view returns(bytes32)
func (_Bridgel2 *Bridgel2CallerSession) GetRoot() ([32]byte, error) {
	return _Bridgel2.Contract.GetRoot(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) GetTokenMetadata(opts *bind.CallOpts, token common.Address) ([]byte, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "getTokenMetadata", token)
...
//
// Solidity: function getTokenMetadata(address token) view returns(bytes)
func (_Bridgel2 *Bridgel2Session) GetTokenMetadata(token common.Address) ([]byte, error) {
	return _Bridgel2.Contract.GetTokenMetadata(&_Bridgel2.CallOpts, token)
}

// GetTokenMetadata is a free data retrieval call binding the contract method 0xc00f14ab.
//
// Solidity: function getTokenMetadata(address token) view returns(bytes)
func (_Bridgel2 *Bridgel2CallerSession) GetTokenMetadata(token common.Address) ([]byte, error) {
	return _Bridgel2.Contract.GetTokenMetadata(&_Bridgel2.CallOpts, token)
}
...
func (_Bridgel2 *Bridgel2Caller) GetTokenWrappedAddress(opts *bind.CallOpts, originNetwork uint32, originTokenAddress common.Address) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "getTokenWrappedAddress", originNetwork, originTokenAddress)
...
//
// Solidity: function getTokenWrappedAddress(uint32 originNetwork, address originTokenAddress) view returns(address)
func (_Bridgel2 *Bridgel2Session) GetTokenWrappedAddress(originNetwork uint32, originTokenAddress common.Address) (common.Address, error) {
	return _Bridgel2.Contract.GetTokenWrappedAddress(&_Bridgel2.CallOpts, originNetwork, originTokenAddress)
}

// GetTokenWrappedAddress is a free data retrieval call binding the contract method 0x22e95f2c.
//
// Solidity: function getTokenWrappedAddress(uint32 originNetwork, address originTokenAddress) view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) GetTokenWrappedAddress(originNetwork uint32, originTokenAddress common.Address) (common.Address, error) {
	return _Bridgel2.Contract.GetTokenWrappedAddress(&_Bridgel2.CallOpts, originNetwork, originTokenAddress)
}
...
func (_Bridgel2 *Bridgel2Caller) GlobalExitRootManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "globalExitRootManager")
...
//
// Solidity: function globalExitRootManager() view returns(address)
func (_Bridgel2 *Bridgel2Session) GlobalExitRootManager() (common.Address, error) {
	return _Bridgel2.Contract.GlobalExitRootManager(&_Bridgel2.CallOpts)
}

// GlobalExitRootManager is a free data retrieval call binding the contract method 0xd02103ca.
//
// Solidity: function globalExitRootManager() view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) GlobalExitRootManager() (common.Address, error) {
	return _Bridgel2.Contract.GlobalExitRootManager(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) IsClaimed(opts *bind.CallOpts, leafIndex uint32, sourceBridgeNetwork uint32) (bool, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "isClaimed", leafIndex, sourceBridgeNetwork)
...
//
// Solidity: function isClaimed(uint32 leafIndex, uint32 sourceBridgeNetwork) view returns(bool)
func (_Bridgel2 *Bridgel2Session) IsClaimed(leafIndex uint32, sourceBridgeNetwork uint32) (bool, error) {
	return _Bridgel2.Contract.IsClaimed(&_Bridgel2.CallOpts, leafIndex, sourceBridgeNetwork)
}

// IsClaimed is a free data retrieval call binding the contract method 0xcc461632.
//
// Solidity: function isClaimed(uint32 leafIndex, uint32 sourceBridgeNetwork) view returns(bool)
func (_Bridgel2 *Bridgel2CallerSession) IsClaimed(leafIndex uint32, sourceBridgeNetwork uint32) (bool, error) {
	return _Bridgel2.Contract.IsClaimed(&_Bridgel2.CallOpts, leafIndex, sourceBridgeNetwork)
}
...
func (_Bridgel2 *Bridgel2Caller) IsEmergencyState(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "isEmergencyState")
...
//
// Solidity: function isEmergencyState() view returns(bool)
func (_Bridgel2 *Bridgel2Session) IsEmergencyState() (bool, error) {
	return _Bridgel2.Contract.IsEmergencyState(&_Bridgel2.CallOpts)
}

// IsEmergencyState is a free data retrieval call binding the contract method 0x15064c96.
//
// Solidity: function isEmergencyState() view returns(bool)
func (_Bridgel2 *Bridgel2CallerSession) IsEmergencyState() (bool, error) {
	return _Bridgel2.Contract.IsEmergencyState(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) LastUpdatedDepositCount(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "lastUpdatedDepositCount")
...
//
// Solidity: function lastUpdatedDepositCount() view returns(uint32)
func (_Bridgel2 *Bridgel2Session) LastUpdatedDepositCount() (uint32, error) {
	return _Bridgel2.Contract.LastUpdatedDepositCount(&_Bridgel2.CallOpts)
}

// LastUpdatedDepositCount is a free data retrieval call binding the contract method 0xbe5831c7.
//
// Solidity: function lastUpdatedDepositCount() view returns(uint32)
func (_Bridgel2 *Bridgel2CallerSession) LastUpdatedDepositCount() (uint32, error) {
	return _Bridgel2.Contract.LastUpdatedDepositCount(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) NetworkID(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "networkID")
...
//
// Solidity: function networkID() view returns(uint32)
func (_Bridgel2 *Bridgel2Session) NetworkID() (uint32, error) {
	return _Bridgel2.Contract.NetworkID(&_Bridgel2.CallOpts)
}

// NetworkID is a free data retrieval call binding the contract method 0xbab161bf.
//
// Solidity: function networkID() view returns(uint32)
func (_Bridgel2 *Bridgel2CallerSession) NetworkID() (uint32, error) {
	return _Bridgel2.Contract.NetworkID(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) PolygonRollupManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "polygonRollupManager")
...
//
// Solidity: function polygonRollupManager() view returns(address)
func (_Bridgel2 *Bridgel2Session) PolygonRollupManager() (common.Address, error) {
	return _Bridgel2.Contract.PolygonRollupManager(&_Bridgel2.CallOpts)
}

// PolygonRollupManager is a free data retrieval call binding the contract method 0x8ed7e3f2.
//
// Solidity: function polygonRollupManager() view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) PolygonRollupManager() (common.Address, error) {
	return _Bridgel2.Contract.PolygonRollupManager(&_Bridgel2.CallOpts)
}
...
func (_Bridgel2 *Bridgel2Caller) PrecalculatedWrapperAddress(opts *bind.CallOpts, originNetwork uint32, originTokenAddress common.Address, name string, symbol string, decimals uint8) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "precalculatedWrapperAddress", originNetwork, originTokenAddress, name, symbol, decimals)
...
//
// Solidity: function precalculatedWrapperAddress(uint32 originNetwork, address originTokenAddress, string name, string symbol, uint8 decimals) view returns(address)
func (_Bridgel2 *Bridgel2Session) PrecalculatedWrapperAddress(originNetwork uint32, originTokenAddress common.Address, name string, symbol string, decimals uint8) (common.Address, error) {
	return _Bridgel2.Contract.PrecalculatedWrapperAddress(&_Bridgel2.CallOpts, originNetwork, originTokenAddress, name, symbol, decimals)
}

// PrecalculatedWrapperAddress is a free data retrieval call binding the contract method 0xaaa13cc2.
//
// Solidity: function precalculatedWrapperAddress(uint32 originNetwork, address originTokenAddress, string name, string symbol, uint8 decimals) view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) PrecalculatedWrapperAddress(originNetwork uint32, originTokenAddress common.Address, name string, symbol string, decimals uint8) (common.Address, error) {
	return _Bridgel2.Contract.PrecalculatedWrapperAddress(&_Bridgel2.CallOpts, originNetwork, originTokenAddress, name, symbol, decimals)
}
...
func (_Bridgel2 *Bridgel2Caller) TokenInfoToWrappedToken(opts *bind.CallOpts, arg0 [32]byte) (common.Address, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "tokenInfoToWrappedToken", arg0)
...
//
// Solidity: function tokenInfoToWrappedToken(bytes32 ) view returns(address)
func (_Bridgel2 *Bridgel2Session) TokenInfoToWrappedToken(arg0 [32]byte) (common.Address, error) {
	return _Bridgel2.Contract.TokenInfoToWrappedToken(&_Bridgel2.CallOpts, arg0)
}

// TokenInfoToWrappedToken is a free data retrieval call binding the contract method 0x81b1c174.
//
// Solidity: function tokenInfoToWrappedToken(bytes32 ) view returns(address)
func (_Bridgel2 *Bridgel2CallerSession) TokenInfoToWrappedToken(arg0 [32]byte) (common.Address, error) {
	return _Bridgel2.Contract.TokenInfoToWrappedToken(&_Bridgel2.CallOpts, arg0)
}
...
func (_Bridgel2 *Bridgel2Caller) VerifyMerkleProof(opts *bind.CallOpts, leafHash [32]byte, smtProof [32][32]byte, index uint32, root [32]byte) (bool, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "verifyMerkleProof", leafHash, smtProof, index, root)
...
//
// Solidity: function verifyMerkleProof(bytes32 leafHash, bytes32[32] smtProof, uint32 index, bytes32 root) pure returns(bool)
func (_Bridgel2 *Bridgel2Session) VerifyMerkleProof(leafHash [32]byte, smtProof [32][32]byte, index uint32, root [32]byte) (bool, error) {
	return _Bridgel2.Contract.VerifyMerkleProof(&_Bridgel2.CallOpts, leafHash, smtProof, index, root)
}

// VerifyMerkleProof is a free data retrieval call binding the contract method 0xfb570834.
//
// Solidity: function verifyMerkleProof(bytes32 leafHash, bytes32[32] smtProof, uint32 index, bytes32 root) pure returns(bool)
func (_Bridgel2 *Bridgel2CallerSession) VerifyMerkleProof(leafHash [32]byte, smtProof [32][32]byte, index uint32, root [32]byte) (bool, error) {
	return _Bridgel2.Contract.VerifyMerkleProof(&_Bridgel2.CallOpts, leafHash, smtProof, index, root)
}
...
func (_Bridgel2 *Bridgel2Caller) WrappedAddressIsNotMintable(opts *bind.CallOpts, wrappedAddress common.Address) (bool, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "wrappedAddressIsNotMintable", wrappedAddress)
...
//
// Solidity: function wrappedAddressIsNotMintable(address wrappedAddress) view returns(bool isNotMintable)
func (_Bridgel2 *Bridgel2Session) WrappedAddressIsNotMintable(wrappedAddress common.Address) (bool, error) {
	return _Bridgel2.Contract.WrappedAddressIsNotMintable(&_Bridgel2.CallOpts, wrappedAddress)
}

// WrappedAddressIsNotMintable is a free data retrieval call binding the contract method 0xc0f49163.
//
// Solidity: function wrappedAddressIsNotMintable(address wrappedAddress) view returns(bool isNotMintable)
func (_Bridgel2 *Bridgel2CallerSession) WrappedAddressIsNotMintable(wrappedAddress common.Address) (bool, error) {
	return _Bridgel2.Contract.WrappedAddressIsNotMintable(&_Bridgel2.CallOpts, wrappedAddress)
}
...
func (_Bridgel2 *Bridgel2Caller) WrappedTokenToTokenInfo(opts *bind.CallOpts, arg0 common.Address) (struct {
	OriginNetwork      uint32
	OriginTokenAddress common.Address
}, error) {
	var out []interface{}
	err := _Bridgel2.contract.Call(opts, &out, "wrappedTokenToTokenInfo", arg0)
...
//
// Solidity: function wrappedTokenToTokenInfo(address ) view returns(uint32 originNetwork, address originTokenAddress)
func (_Bridgel2 *Bridgel2Session) WrappedTokenToTokenInfo(arg0 common.Address) (struct {
	OriginNetwork      uint32
	OriginTokenAddress common.Address
}, error) {
	return _Bridgel2.Contract.WrappedTokenToTokenInfo(&_Bridgel2.CallOpts, arg0)
}

// WrappedTokenToTokenInfo is a free data retrieval call binding the contract method 0x318aee3d.
//
// Solidity: function wrappedTokenToTokenInfo(address ) view returns(uint32 originNetwork, address originTokenAddress)
func (_Bridgel2 *Bridgel2CallerSession) WrappedTokenToTokenInfo(arg0 common.Address) (struct {
	OriginNetwork      uint32
	OriginTokenAddress common.Address
}, error) {
	return _Bridgel2.Contract.WrappedTokenToTokenInfo(&_Bridgel2.CallOpts, arg0)
...
func (_Bridgel2 *Bridgel2Transactor) ActivateEmergencyState(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "activateEmergencyState")
}

// ActivateEmergencyState is a paid mutator transaction binding the contract method 0x2072f6c5.
//
// Solidity: function activateEmergencyState() returns()
func (_Bridgel2 *Bridgel2Session) ActivateEmergencyState() (*types.Transaction, error) {
	return _Bridgel2.Contract.ActivateEmergencyState(&_Bridgel2.TransactOpts)
}

// ActivateEmergencyState is a paid mutator transaction binding the contract method 0x2072f6c5.
//
// Solidity: function activateEmergencyState() returns()
func (_Bridgel2 *Bridgel2TransactorSession) ActivateEmergencyState() (*types.Transaction, error) {
	return _Bridgel2.Contract.ActivateEmergencyState(&_Bridgel2.TransactOpts)
}
...
func (_Bridgel2 *Bridgel2Transactor) BridgeAsset(opts *bind.TransactOpts, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, token common.Address, forceUpdateGlobalExitRoot bool, permitData []byte) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "bridgeAsset", destinationNetwork, destinationAddress, amount, token, forceUpdateGlobalExitRoot, permitData)
}

// BridgeAsset is a paid mutator transaction binding the contract method 0xcd586579.
//
// Solidity: function bridgeAsset(uint32 destinationNetwork, address destinationAddress, uint256 amount, address token, bool forceUpdateGlobalExitRoot, bytes permitData) payable returns()
func (_Bridgel2 *Bridgel2Session) BridgeAsset(destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, token common.Address, forceUpdateGlobalExitRoot bool, permitData []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.BridgeAsset(&_Bridgel2.TransactOpts, destinationNetwork, destinationAddress, amount, token, forceUpdateGlobalExitRoot, permitData)
}

// BridgeAsset is a paid mutator transaction binding the contract method 0xcd586579.
//
// Solidity: function bridgeAsset(uint32 destinationNetwork, address destinationAddress, uint256 amount, address token, bool forceUpdateGlobalExitRoot, bytes permitData) payable returns()
func (_Bridgel2 *Bridgel2TransactorSession) BridgeAsset(destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, token common.Address, forceUpdateGlobalExitRoot bool, permitData []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.BridgeAsset(&_Bridgel2.TransactOpts, destinationNetwork, destinationAddress, amount, token, forceUpdateGlobalExitRoot, permitData)
}
...
func (_Bridgel2 *Bridgel2Transactor) BridgeMessage(opts *bind.TransactOpts, destinationNetwork uint32, destinationAddress common.Address, forceUpdateGlobalExitRoot bool, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "bridgeMessage", destinationNetwork, destinationAddress, forceUpdateGlobalExitRoot, metadata)
}

// BridgeMessage is a paid mutator transaction binding the contract method 0x240ff378.
//
// Solidity: function bridgeMessage(uint32 destinationNetwork, address destinationAddress, bool forceUpdateGlobalExitRoot, bytes metadata) payable returns()
func (_Bridgel2 *Bridgel2Session) BridgeMessage(destinationNetwork uint32, destinationAddress common.Address, forceUpdateGlobalExitRoot bool, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.BridgeMessage(&_Bridgel2.TransactOpts, destinationNetwork, destinationAddress, forceUpdateGlobalExitRoot, metadata)
}

// BridgeMessage is a paid mutator transaction binding the contract method 0x240ff378.
//
// Solidity: function bridgeMessage(uint32 destinationNetwork, address destinationAddress, bool forceUpdateGlobalExitRoot, bytes metadata) payable returns()
func (_Bridgel2 *Bridgel2TransactorSession) BridgeMessage(destinationNetwork uint32, destinationAddress common.Address, forceUpdateGlobalExitRoot bool, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.BridgeMessage(&_Bridgel2.TransactOpts, destinationNetwork, destinationAddress, forceUpdateGlobalExitRoot, metadata)
}
...
func (_Bridgel2 *Bridgel2Transactor) BridgeMessageWETH(opts *bind.TransactOpts, destinationNetwork uint32, destinationAddress common.Address, amountWETH *big.Int, forceUpdateGlobalExitRoot bool, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "bridgeMessageWETH", destinationNetwork, destinationAddress, amountWETH, forceUpdateGlobalExitRoot, metadata)
}

// BridgeMessageWETH is a paid mutator transaction binding the contract method 0xb8b284d0.
//
// Solidity: function bridgeMessageWETH(uint32 destinationNetwork, address destinationAddress, uint256 amountWETH, bool forceUpdateGlobalExitRoot, bytes metadata) returns()
func (_Bridgel2 *Bridgel2Session) BridgeMessageWETH(destinationNetwork uint32, destinationAddress common.Address, amountWETH *big.Int, forceUpdateGlobalExitRoot bool, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.BridgeMessageWETH(&_Bridgel2.TransactOpts, destinationNetwork, destinationAddress, amountWETH, forceUpdateGlobalExitRoot, metadata)
}

// BridgeMessageWETH is a paid mutator transaction binding the contract method 0xb8b284d0.
//
// Solidity: function bridgeMessageWETH(uint32 destinationNetwork, address destinationAddress, uint256 amountWETH, bool forceUpdateGlobalExitRoot, bytes metadata) returns()
func (_Bridgel2 *Bridgel2TransactorSession) BridgeMessageWETH(destinationNetwork uint32, destinationAddress common.Address, amountWETH *big.Int, forceUpdateGlobalExitRoot bool, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.BridgeMessageWETH(&_Bridgel2.TransactOpts, destinationNetwork, destinationAddress, amountWETH, forceUpdateGlobalExitRoot, metadata)
}
...
func (_Bridgel2 *Bridgel2Transactor) ClaimAsset(opts *bind.TransactOpts, smtProofLocalExitRoot [32][32]byte, smtProofRollupExitRoot [32][32]byte, globalIndex *big.Int, mainnetExitRoot [32]byte, rollupExitRoot [32]byte, originNetwork uint32, originTokenAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "claimAsset", smtProofLocalExitRoot, smtProofRollupExitRoot, globalIndex, mainnetExitRoot, rollupExitRoot, originNetwork, originTokenAddress, destinationNetwork, destinationAddress, amount, metadata)
}

// ClaimAsset is a paid mutator transaction binding the contract method 0xccaa2d11.
//
// Solidity: function claimAsset(bytes32[32] smtProofLocalExitRoot, bytes32[32] smtProofRollupExitRoot, uint256 globalIndex, bytes32 mainnetExitRoot, bytes32 rollupExitRoot, uint32 originNetwork, address originTokenAddress, uint32 destinationNetwork, address destinationAddress, uint256 amount, bytes metadata) returns()
func (_Bridgel2 *Bridgel2Session) ClaimAsset(smtProofLocalExitRoot [32][32]byte, smtProofRollupExitRoot [32][32]byte, globalIndex *big.Int, mainnetExitRoot [32]byte, rollupExitRoot [32]byte, originNetwork uint32, originTokenAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.ClaimAsset(&_Bridgel2.TransactOpts, smtProofLocalExitRoot, smtProofRollupExitRoot, globalIndex, mainnetExitRoot, rollupExitRoot, originNetwork, originTokenAddress, destinationNetwork, destinationAddress, amount, metadata)
}

// ClaimAsset is a paid mutator transaction binding the contract method 0xccaa2d11.
//
// Solidity: function claimAsset(bytes32[32] smtProofLocalExitRoot, bytes32[32] smtProofRollupExitRoot, uint256 globalIndex, bytes32 mainnetExitRoot, bytes32 rollupExitRoot, uint32 originNetwork, address originTokenAddress, uint32 destinationNetwork, address destinationAddress, uint256 amount, bytes metadata) returns()
func (_Bridgel2 *Bridgel2TransactorSession) ClaimAsset(smtProofLocalExitRoot [32][32]byte, smtProofRollupExitRoot [32][32]byte, globalIndex *big.Int, mainnetExitRoot [32]byte, rollupExitRoot [32]byte, originNetwork uint32, originTokenAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.ClaimAsset(&_Bridgel2.TransactOpts, smtProofLocalExitRoot, smtProofRollupExitRoot, globalIndex, mainnetExitRoot, rollupExitRoot, originNetwork, originTokenAddress, destinationNetwork, destinationAddress, amount, metadata)
}
...
func (_Bridgel2 *Bridgel2Transactor) ClaimMessage(opts *bind.TransactOpts, smtProofLocalExitRoot [32][32]byte, smtProofRollupExitRoot [32][32]byte, globalIndex *big.Int, mainnetExitRoot [32]byte, rollupExitRoot [32]byte, originNetwork uint32, originAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "claimMessage", smtProofLocalExitRoot, smtProofRollupExitRoot, globalIndex, mainnetExitRoot, rollupExitRoot, originNetwork, originAddress, destinationNetwork, destinationAddress, amount, metadata)
}

// ClaimMessage is a paid mutator transaction binding the contract method 0xf5efcd79.
//
// Solidity: function claimMessage(bytes32[32] smtProofLocalExitRoot, bytes32[32] smtProofRollupExitRoot, uint256 globalIndex, bytes32 mainnetExitRoot, bytes32 rollupExitRoot, uint32 originNetwork, address originAddress, uint32 destinationNetwork, address destinationAddress, uint256 amount, bytes metadata) returns()
func (_Bridgel2 *Bridgel2Session) ClaimMessage(smtProofLocalExitRoot [32][32]byte, smtProofRollupExitRoot [32][32]byte, globalIndex *big.Int, mainnetExitRoot [32]byte, rollupExitRoot [32]byte, originNetwork uint32, originAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.ClaimMessage(&_Bridgel2.TransactOpts, smtProofLocalExitRoot, smtProofRollupExitRoot, globalIndex, mainnetExitRoot, rollupExitRoot, originNetwork, originAddress, destinationNetwork, destinationAddress, amount, metadata)
}

// ClaimMessage is a paid mutator transaction binding the contract method 0xf5efcd79.
//
// Solidity: function claimMessage(bytes32[32] smtProofLocalExitRoot, bytes32[32] smtProofRollupExitRoot, uint256 globalIndex, bytes32 mainnetExitRoot, bytes32 rollupExitRoot, uint32 originNetwork, address originAddress, uint32 destinationNetwork, address destinationAddress, uint256 amount, bytes metadata) returns()
func (_Bridgel2 *Bridgel2TransactorSession) ClaimMessage(smtProofLocalExitRoot [32][32]byte, smtProofRollupExitRoot [32][32]byte, globalIndex *big.Int, mainnetExitRoot [32]byte, rollupExitRoot [32]byte, originNetwork uint32, originAddress common.Address, destinationNetwork uint32, destinationAddress common.Address, amount *big.Int, metadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.ClaimMessage(&_Bridgel2.TransactOpts, smtProofLocalExitRoot, smtProofRollupExitRoot, globalIndex, mainnetExitRoot, rollupExitRoot, originNetwork, originAddress, destinationNetwork, destinationAddress, amount, metadata)
}
...
func (_Bridgel2 *Bridgel2Transactor) DeactivateEmergencyState(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "deactivateEmergencyState")
}

// DeactivateEmergencyState is a paid mutator transaction binding the contract method 0xdbc16976.
//
// Solidity: function deactivateEmergencyState() returns()
func (_Bridgel2 *Bridgel2Session) DeactivateEmergencyState() (*types.Transaction, error) {
	return _Bridgel2.Contract.DeactivateEmergencyState(&_Bridgel2.TransactOpts)
}

// DeactivateEmergencyState is a paid mutator transaction binding the contract method 0xdbc16976.
//
// Solidity: function deactivateEmergencyState() returns()
func (_Bridgel2 *Bridgel2TransactorSession) DeactivateEmergencyState() (*types.Transaction, error) {
	return _Bridgel2.Contract.DeactivateEmergencyState(&_Bridgel2.TransactOpts)
}
...
func (_Bridgel2 *Bridgel2Transactor) Initialize(opts *bind.TransactOpts, _networkID uint32, _gasTokenAddress common.Address, _gasTokenNetwork uint32, _globalExitRootManager common.Address, _polygonRollupManager common.Address, _gasTokenMetadata []byte, _bridgeManager common.Address, _sovereignWETHAddress common.Address, _sovereignWETHAddressIsNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "initialize", _networkID, _gasTokenAddress, _gasTokenNetwork, _globalExitRootManager, _polygonRollupManager, _gasTokenMetadata, _bridgeManager, _sovereignWETHAddress, _sovereignWETHAddressIsNotMintable)
}

// Initialize is a paid mutator transaction binding the contract method 0x8c0dd470.
//
// Solidity: function initialize(uint32 _networkID, address _gasTokenAddress, uint32 _gasTokenNetwork, address _globalExitRootManager, address _polygonRollupManager, bytes _gasTokenMetadata, address _bridgeManager, address _sovereignWETHAddress, bool _sovereignWETHAddressIsNotMintable) returns()
func (_Bridgel2 *Bridgel2Session) Initialize(_networkID uint32, _gasTokenAddress common.Address, _gasTokenNetwork uint32, _globalExitRootManager common.Address, _polygonRollupManager common.Address, _gasTokenMetadata []byte, _bridgeManager common.Address, _sovereignWETHAddress common.Address, _sovereignWETHAddressIsNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.Contract.Initialize(&_Bridgel2.TransactOpts, _networkID, _gasTokenAddress, _gasTokenNetwork, _globalExitRootManager, _polygonRollupManager, _gasTokenMetadata, _bridgeManager, _sovereignWETHAddress, _sovereignWETHAddressIsNotMintable)
}

// Initialize is a paid mutator transaction binding the contract method 0x8c0dd470.
//
// Solidity: function initialize(uint32 _networkID, address _gasTokenAddress, uint32 _gasTokenNetwork, address _globalExitRootManager, address _polygonRollupManager, bytes _gasTokenMetadata, address _bridgeManager, address _sovereignWETHAddress, bool _sovereignWETHAddressIsNotMintable) returns()
func (_Bridgel2 *Bridgel2TransactorSession) Initialize(_networkID uint32, _gasTokenAddress common.Address, _gasTokenNetwork uint32, _globalExitRootManager common.Address, _polygonRollupManager common.Address, _gasTokenMetadata []byte, _bridgeManager common.Address, _sovereignWETHAddress common.Address, _sovereignWETHAddressIsNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.Contract.Initialize(&_Bridgel2.TransactOpts, _networkID, _gasTokenAddress, _gasTokenNetwork, _globalExitRootManager, _polygonRollupManager, _gasTokenMetadata, _bridgeManager, _sovereignWETHAddress, _sovereignWETHAddressIsNotMintable)
}
...
func (_Bridgel2 *Bridgel2Transactor) Initialize0(opts *bind.TransactOpts, _networkID uint32, _gasTokenAddress common.Address, _gasTokenNetwork uint32, _globalExitRootManager common.Address, _polygonRollupManager common.Address, _gasTokenMetadata []byte) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "initialize0", _networkID, _gasTokenAddress, _gasTokenNetwork, _globalExitRootManager, _polygonRollupManager, _gasTokenMetadata)
}

// Initialize0 is a paid mutator transaction binding the contract method 0xf811bff7.
//
// Solidity: function initialize(uint32 _networkID, address _gasTokenAddress, uint32 _gasTokenNetwork, address _globalExitRootManager, address _polygonRollupManager, bytes _gasTokenMetadata) returns()
func (_Bridgel2 *Bridgel2Session) Initialize0(_networkID uint32, _gasTokenAddress common.Address, _gasTokenNetwork uint32, _globalExitRootManager common.Address, _polygonRollupManager common.Address, _gasTokenMetadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.Initialize0(&_Bridgel2.TransactOpts, _networkID, _gasTokenAddress, _gasTokenNetwork, _globalExitRootManager, _polygonRollupManager, _gasTokenMetadata)
}

// Initialize0 is a paid mutator transaction binding the contract method 0xf811bff7.
//
// Solidity: function initialize(uint32 _networkID, address _gasTokenAddress, uint32 _gasTokenNetwork, address _globalExitRootManager, address _polygonRollupManager, bytes _gasTokenMetadata) returns()
func (_Bridgel2 *Bridgel2TransactorSession) Initialize0(_networkID uint32, _gasTokenAddress common.Address, _gasTokenNetwork uint32, _globalExitRootManager common.Address, _polygonRollupManager common.Address, _gasTokenMetadata []byte) (*types.Transaction, error) {
	return _Bridgel2.Contract.Initialize0(&_Bridgel2.TransactOpts, _networkID, _gasTokenAddress, _gasTokenNetwork, _globalExitRootManager, _polygonRollupManager, _gasTokenMetadata)
}
...
func (_Bridgel2 *Bridgel2Transactor) MigrateLegacyToken(opts *bind.TransactOpts, legacyTokenAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "migrateLegacyToken", legacyTokenAddress, amount)
}

// MigrateLegacyToken is a paid mutator transaction binding the contract method 0x9e76158f.
//
// Solidity: function migrateLegacyToken(address legacyTokenAddress, uint256 amount) returns()
func (_Bridgel2 *Bridgel2Session) MigrateLegacyToken(legacyTokenAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Bridgel2.Contract.MigrateLegacyToken(&_Bridgel2.TransactOpts, legacyTokenAddress, amount)
}

// MigrateLegacyToken is a paid mutator transaction binding the contract method 0x9e76158f.
//
// Solidity: function migrateLegacyToken(address legacyTokenAddress, uint256 amount) returns()
func (_Bridgel2 *Bridgel2TransactorSession) MigrateLegacyToken(legacyTokenAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _Bridgel2.Contract.MigrateLegacyToken(&_Bridgel2.TransactOpts, legacyTokenAddress, amount)
}
...
func (_Bridgel2 *Bridgel2Transactor) RemoveSovereignTokenAddress(opts *bind.TransactOpts, sovereignTokenAddress common.Address) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "removeSovereignTokenAddress", sovereignTokenAddress)
}

// RemoveSovereignTokenAddress is a paid mutator transaction binding the contract method 0x4b8664f3.
//
// Solidity: function removeSovereignTokenAddress(address sovereignTokenAddress) returns()
func (_Bridgel2 *Bridgel2Session) RemoveSovereignTokenAddress(sovereignTokenAddress common.Address) (*types.Transaction, error) {
	return _Bridgel2.Contract.RemoveSovereignTokenAddress(&_Bridgel2.TransactOpts, sovereignTokenAddress)
}

// RemoveSovereignTokenAddress is a paid mutator transaction binding the contract method 0x4b8664f3.
//
// Solidity: function removeSovereignTokenAddress(address sovereignTokenAddress) returns()
func (_Bridgel2 *Bridgel2TransactorSession) RemoveSovereignTokenAddress(sovereignTokenAddress common.Address) (*types.Transaction, error) {
	return _Bridgel2.Contract.RemoveSovereignTokenAddress(&_Bridgel2.TransactOpts, sovereignTokenAddress)
}
...
func (_Bridgel2 *Bridgel2Transactor) SetBridgeManager(opts *bind.TransactOpts, _bridgeManager common.Address) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "setBridgeManager", _bridgeManager)
}

// SetBridgeManager is a paid mutator transaction binding the contract method 0xeabd372a.
//
// Solidity: function setBridgeManager(address _bridgeManager) returns()
func (_Bridgel2 *Bridgel2Session) SetBridgeManager(_bridgeManager common.Address) (*types.Transaction, error) {
	return _Bridgel2.Contract.SetBridgeManager(&_Bridgel2.TransactOpts, _bridgeManager)
}

// SetBridgeManager is a paid mutator transaction binding the contract method 0xeabd372a.
//
// Solidity: function setBridgeManager(address _bridgeManager) returns()
func (_Bridgel2 *Bridgel2TransactorSession) SetBridgeManager(_bridgeManager common.Address) (*types.Transaction, error) {
	return _Bridgel2.Contract.SetBridgeManager(&_Bridgel2.TransactOpts, _bridgeManager)
}
...
func (_Bridgel2 *Bridgel2Transactor) SetMultipleSovereignTokenAddress(opts *bind.TransactOpts, sovereignTokenAddresses []BridgeL2SovereignChainSovereignTokenAddress) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "setMultipleSovereignTokenAddress", sovereignTokenAddresses)
}

// SetMultipleSovereignTokenAddress is a paid mutator transaction binding the contract method 0xbedf6a5a.
//
// Solidity: function setMultipleSovereignTokenAddress((uint32,address,address,bool)[] sovereignTokenAddresses) returns()
func (_Bridgel2 *Bridgel2Session) SetMultipleSovereignTokenAddress(sovereignTokenAddresses []BridgeL2SovereignChainSovereignTokenAddress) (*types.Transaction, error) {
	return _Bridgel2.Contract.SetMultipleSovereignTokenAddress(&_Bridgel2.TransactOpts, sovereignTokenAddresses)
}

// SetMultipleSovereignTokenAddress is a paid mutator transaction binding the contract method 0xbedf6a5a.
//
// Solidity: function setMultipleSovereignTokenAddress((uint32,address,address,bool)[] sovereignTokenAddresses) returns()
func (_Bridgel2 *Bridgel2TransactorSession) SetMultipleSovereignTokenAddress(sovereignTokenAddresses []BridgeL2SovereignChainSovereignTokenAddress) (*types.Transaction, error) {
	return _Bridgel2.Contract.SetMultipleSovereignTokenAddress(&_Bridgel2.TransactOpts, sovereignTokenAddresses)
}
...
func (_Bridgel2 *Bridgel2Transactor) SetSovereignTokenAddress(opts *bind.TransactOpts, originNetwork uint32, originTokenAddress common.Address, sovereignTokenAddress common.Address, isNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "setSovereignTokenAddress", originNetwork, originTokenAddress, sovereignTokenAddress, isNotMintable)
}

// SetSovereignTokenAddress is a paid mutator transaction binding the contract method 0xb42f6b3a.
//
// Solidity: function setSovereignTokenAddress(uint32 originNetwork, address originTokenAddress, address sovereignTokenAddress, bool isNotMintable) returns()
func (_Bridgel2 *Bridgel2Session) SetSovereignTokenAddress(originNetwork uint32, originTokenAddress common.Address, sovereignTokenAddress common.Address, isNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.Contract.SetSovereignTokenAddress(&_Bridgel2.TransactOpts, originNetwork, originTokenAddress, sovereignTokenAddress, isNotMintable)
}

// SetSovereignTokenAddress is a paid mutator transaction binding the contract method 0xb42f6b3a.
//
// Solidity: function setSovereignTokenAddress(uint32 originNetwork, address originTokenAddress, address sovereignTokenAddress, bool isNotMintable) returns()
func (_Bridgel2 *Bridgel2TransactorSession) SetSovereignTokenAddress(originNetwork uint32, originTokenAddress common.Address, sovereignTokenAddress common.Address, isNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.Contract.SetSovereignTokenAddress(&_Bridgel2.TransactOpts, originNetwork, originTokenAddress, sovereignTokenAddress, isNotMintable)
}
...
func (_Bridgel2 *Bridgel2Transactor) SetSovereignWETHAddress(opts *bind.TransactOpts, sovereignWETHTokenAddress common.Address, isNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "setSovereignWETHAddress", sovereignWETHTokenAddress, isNotMintable)
}

// SetSovereignWETHAddress is a paid mutator transaction binding the contract method 0xbf130d7f.
//
// Solidity: function setSovereignWETHAddress(address sovereignWETHTokenAddress, bool isNotMintable) returns()
func (_Bridgel2 *Bridgel2Session) SetSovereignWETHAddress(sovereignWETHTokenAddress common.Address, isNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.Contract.SetSovereignWETHAddress(&_Bridgel2.TransactOpts, sovereignWETHTokenAddress, isNotMintable)
}

// SetSovereignWETHAddress is a paid mutator transaction binding the contract method 0xbf130d7f.
//
// Solidity: function setSovereignWETHAddress(address sovereignWETHTokenAddress, bool isNotMintable) returns()
func (_Bridgel2 *Bridgel2TransactorSession) SetSovereignWETHAddress(sovereignWETHTokenAddress common.Address, isNotMintable bool) (*types.Transaction, error) {
	return _Bridgel2.Contract.SetSovereignWETHAddress(&_Bridgel2.TransactOpts, sovereignWETHTokenAddress, isNotMintable)
}
...
func (_Bridgel2 *Bridgel2Transactor) UpdateGlobalExitRoot(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Bridgel2.contract.Transact(opts, "updateGlobalExitRoot")
}

// UpdateGlobalExitRoot is a paid mutator transaction binding the contract method 0x79e2cf97.
//
// Solidity: function updateGlobalExitRoot() returns()
func (_Bridgel2 *Bridgel2Session) UpdateGlobalExitRoot() (*types.Transaction, error) {
	return _Bridgel2.Contract.UpdateGlobalExitRoot(&_Bridgel2.TransactOpts)
}

// UpdateGlobalExitRoot is a paid mutator transaction binding the contract method 0x79e2cf97.
//
// Solidity: function updateGlobalExitRoot() returns()
func (_Bridgel2 *Bridgel2TransactorSession) UpdateGlobalExitRoot() (*types.Transaction, error) {
	return _Bridgel2.Contract.UpdateGlobalExitRoot(&_Bridgel2.TransactOpts)
}

// Bridgel2BridgeEventIterator is returned from FilterBridgeEvent and is used to iterate over the raw logs and unpacked data for BridgeEvent events raised by the Bridgel2 contract.
type Bridgel2BridgeEventIterator struct {
	Event *Bridgel2BridgeEvent // Event containing the contract specifics and raw log
...
func (it *Bridgel2BridgeEventIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2BridgeEvent)
...
func (it *Bridgel2BridgeEventIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2BridgeEventIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2BridgeEvent represents a BridgeEvent event raised by the Bridgel2 contract.
type Bridgel2BridgeEvent struct {
	LeafType           uint8
	OriginNetwork      uint32
...
func (_Bridgel2 *Bridgel2Filterer) FilterBridgeEvent(opts *bind.FilterOpts) (*Bridgel2BridgeEventIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "BridgeEvent")
	if err != nil {
		return nil, err
	}
	return &Bridgel2BridgeEventIterator{contract: _Bridgel2.contract, event: "BridgeEvent", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event BridgeEvent(uint8 leafType, uint32 originNetwork, address originAddress, uint32 destinationNetwork, address destinationAddress, uint256 amount, bytes metadata, uint32 depositCount)
func (_Bridgel2 *Bridgel2Filterer) WatchBridgeEvent(opts *bind.WatchOpts, sink chan<- *Bridgel2BridgeEvent) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "BridgeEvent")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(Bridgel2BridgeEvent)
				if err := _Bridgel2.contract.UnpackLog(event, "BridgeEvent", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BridgeEvent(uint8 leafType, uint32 originNetwork, address originAddress, uint32 destinationNetwork, address destinationAddress, uint256 amount, bytes metadata, uint32 depositCount)
func (_Bridgel2 *Bridgel2Filterer) ParseBridgeEvent(log types.Log) (*Bridgel2BridgeEvent, error) {
	event := new(Bridgel2BridgeEvent)
	if err := _Bridgel2.contract.UnpackLog(event, "BridgeEvent", log); err != nil {
		return nil, err
	}
...
// Bridgel2BridgeManagerUpdatedIterator is returned from FilterBridgeManagerUpdated and is used to iterate over the raw logs and unpacked data for BridgeManagerUpdated events raised by the Bridgel2 contract.
type Bridgel2BridgeManagerUpdatedIterator struct {
	Event *Bridgel2BridgeManagerUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2BridgeManagerUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2BridgeManagerUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2BridgeManagerUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2BridgeManagerUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2BridgeManagerUpdated represents a BridgeManagerUpdated event raised by the Bridgel2 contract.
type Bridgel2BridgeManagerUpdated struct {
...
func (_Bridgel2 *Bridgel2Filterer) FilterBridgeManagerUpdated(opts *bind.FilterOpts) (*Bridgel2BridgeManagerUpdatedIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "BridgeManagerUpdated")
	if err != nil {
		return nil, err
	}
	return &Bridgel2BridgeManagerUpdatedIterator{contract: _Bridgel2.contract, event: "BridgeManagerUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event BridgeManagerUpdated(address bridgeManager)
func (_Bridgel2 *Bridgel2Filterer) WatchBridgeManagerUpdated(opts *bind.WatchOpts, sink chan<- *Bridgel2BridgeManagerUpdated) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "BridgeManagerUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2BridgeManagerUpdated)
				if err := _Bridgel2.contract.UnpackLog(event, "BridgeManagerUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BridgeManagerUpdated(address bridgeManager)
func (_Bridgel2 *Bridgel2Filterer) ParseBridgeManagerUpdated(log types.Log) (*Bridgel2BridgeManagerUpdated, error) {
	event := new(Bridgel2BridgeManagerUpdated)
	if err := _Bridgel2.contract.UnpackLog(event, "BridgeManagerUpdated", log); err != nil {
		return nil, err
	}
...
// Bridgel2ClaimEventIterator is returned from FilterClaimEvent and is used to iterate over the raw logs and unpacked data for ClaimEvent events raised by the Bridgel2 contract.
type Bridgel2ClaimEventIterator struct {
	Event *Bridgel2ClaimEvent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2ClaimEventIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2ClaimEvent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2ClaimEventIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2ClaimEventIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2ClaimEvent represents a ClaimEvent event raised by the Bridgel2 contract.
type Bridgel2ClaimEvent struct {
	GlobalIndex        *big.Int
	OriginNetwork      uint32
	OriginAddress      common.Address
	DestinationAddress common.Address
...
func (_Bridgel2 *Bridgel2Filterer) FilterClaimEvent(opts *bind.FilterOpts) (*Bridgel2ClaimEventIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "ClaimEvent")
	if err != nil {
		return nil, err
	}
	return &Bridgel2ClaimEventIterator{contract: _Bridgel2.contract, event: "ClaimEvent", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ClaimEvent(uint256 globalIndex, uint32 originNetwork, address originAddress, address destinationAddress, uint256 amount)
func (_Bridgel2 *Bridgel2Filterer) WatchClaimEvent(opts *bind.WatchOpts, sink chan<- *Bridgel2ClaimEvent) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "ClaimEvent")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2ClaimEvent)
				if err := _Bridgel2.contract.UnpackLog(event, "ClaimEvent", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ClaimEvent(uint256 globalIndex, uint32 originNetwork, address originAddress, address destinationAddress, uint256 amount)
func (_Bridgel2 *Bridgel2Filterer) ParseClaimEvent(log types.Log) (*Bridgel2ClaimEvent, error) {
	event := new(Bridgel2ClaimEvent)
	if err := _Bridgel2.contract.UnpackLog(event, "ClaimEvent", log); err != nil {
		return nil, err
	}
...
// Bridgel2EmergencyStateActivatedIterator is returned from FilterEmergencyStateActivated and is used to iterate over the raw logs and unpacked data for EmergencyStateActivated events raised by the Bridgel2 contract.
type Bridgel2EmergencyStateActivatedIterator struct {
	Event *Bridgel2EmergencyStateActivated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2EmergencyStateActivatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2EmergencyStateActivated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2EmergencyStateActivatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2EmergencyStateActivatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2EmergencyStateActivated represents a EmergencyStateActivated event raised by the Bridgel2 contract.
type Bridgel2EmergencyStateActivated struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_Bridgel2 *Bridgel2Filterer) FilterEmergencyStateActivated(opts *bind.FilterOpts) (*Bridgel2EmergencyStateActivatedIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "EmergencyStateActivated")
	if err != nil {
		return nil, err
	}
	return &Bridgel2EmergencyStateActivatedIterator{contract: _Bridgel2.contract, event: "EmergencyStateActivated", logs: logs, sub: sub}, nil
}

// WatchEmergencyStateActivated is a free log subscription operation binding the contract event 0x2261efe5aef6fedc1fd1550b25facc9181745623049c7901287030b9ad1a5497.
//
// Solidity: event EmergencyStateActivated()
func (_Bridgel2 *Bridgel2Filterer) WatchEmergencyStateActivated(opts *bind.WatchOpts, sink chan<- *Bridgel2EmergencyStateActivated) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "EmergencyStateActivated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2EmergencyStateActivated)
				if err := _Bridgel2.contract.UnpackLog(event, "EmergencyStateActivated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event EmergencyStateActivated()
func (_Bridgel2 *Bridgel2Filterer) ParseEmergencyStateActivated(log types.Log) (*Bridgel2EmergencyStateActivated, error) {
	event := new(Bridgel2EmergencyStateActivated)
	if err := _Bridgel2.contract.UnpackLog(event, "EmergencyStateActivated", log); err != nil {
		return nil, err
	}
...
// Bridgel2EmergencyStateDeactivatedIterator is returned from FilterEmergencyStateDeactivated and is used to iterate over the raw logs and unpacked data for EmergencyStateDeactivated events raised by the Bridgel2 contract.
type Bridgel2EmergencyStateDeactivatedIterator struct {
	Event *Bridgel2EmergencyStateDeactivated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2EmergencyStateDeactivatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2EmergencyStateDeactivated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2EmergencyStateDeactivatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2EmergencyStateDeactivatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2EmergencyStateDeactivated represents a EmergencyStateDeactivated event raised by the Bridgel2 contract.
type Bridgel2EmergencyStateDeactivated struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_Bridgel2 *Bridgel2Filterer) FilterEmergencyStateDeactivated(opts *bind.FilterOpts) (*Bridgel2EmergencyStateDeactivatedIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "EmergencyStateDeactivated")
	if err != nil {
		return nil, err
	}
	return &Bridgel2EmergencyStateDeactivatedIterator{contract: _Bridgel2.contract, event: "EmergencyStateDeactivated", logs: logs, sub: sub}, nil
}

// WatchEmergencyStateDeactivated is a free log subscription operation binding the contract event 0x1e5e34eea33501aecf2ebec9fe0e884a40804275ea7fe10b2ba084c8374308b3.
//
// Solidity: event EmergencyStateDeactivated()
func (_Bridgel2 *Bridgel2Filterer) WatchEmergencyStateDeactivated(opts *bind.WatchOpts, sink chan<- *Bridgel2EmergencyStateDeactivated) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "EmergencyStateDeactivated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2EmergencyStateDeactivated)
				if err := _Bridgel2.contract.UnpackLog(event, "EmergencyStateDeactivated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event EmergencyStateDeactivated()
func (_Bridgel2 *Bridgel2Filterer) ParseEmergencyStateDeactivated(log types.Log) (*Bridgel2EmergencyStateDeactivated, error) {
	event := new(Bridgel2EmergencyStateDeactivated)
	if err := _Bridgel2.contract.UnpackLog(event, "EmergencyStateDeactivated", log); err != nil {
		return nil, err
	}
...
// Bridgel2InitializedIterator is returned from FilterInitialized and is used to iterate over the raw logs and unpacked data for Initialized events raised by the Bridgel2 contract.
type Bridgel2InitializedIterator struct {
	Event *Bridgel2Initialized // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2InitializedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2Initialized)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2InitializedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2InitializedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2Initialized represents a Initialized event raised by the Bridgel2 contract.
type Bridgel2Initialized struct {
	Version uint8
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_Bridgel2 *Bridgel2Filterer) FilterInitialized(opts *bind.FilterOpts) (*Bridgel2InitializedIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return &Bridgel2InitializedIterator{contract: _Bridgel2.contract, event: "Initialized", logs: logs, sub: sub}, nil
}

// WatchInitialized is a free log subscription operation binding the contract event 0x7f26b83ff96e1f2b6a682f133852f6798a09c465da95921460cefb3847402498.
//
// Solidity: event Initialized(uint8 version)
func (_Bridgel2 *Bridgel2Filterer) WatchInitialized(opts *bind.WatchOpts, sink chan<- *Bridgel2Initialized) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2Initialized)
				if err := _Bridgel2.contract.UnpackLog(event, "Initialized", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Initialized(uint8 version)
func (_Bridgel2 *Bridgel2Filterer) ParseInitialized(log types.Log) (*Bridgel2Initialized, error) {
	event := new(Bridgel2Initialized)
	if err := _Bridgel2.contract.UnpackLog(event, "Initialized", log); err != nil {
		return nil, err
	}
...
// Bridgel2MigrateLegacyTokenIterator is returned from FilterMigrateLegacyToken and is used to iterate over the raw logs and unpacked data for MigrateLegacyToken events raised by the Bridgel2 contract.
type Bridgel2MigrateLegacyTokenIterator struct {
	Event *Bridgel2MigrateLegacyToken // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2MigrateLegacyTokenIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2MigrateLegacyToken)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2MigrateLegacyTokenIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2MigrateLegacyTokenIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2MigrateLegacyToken represents a MigrateLegacyToken event raised by the Bridgel2 contract.
type Bridgel2MigrateLegacyToken struct {
...
func (_Bridgel2 *Bridgel2Filterer) FilterMigrateLegacyToken(opts *bind.FilterOpts) (*Bridgel2MigrateLegacyTokenIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "MigrateLegacyToken")
	if err != nil {
		return nil, err
	}
	return &Bridgel2MigrateLegacyTokenIterator{contract: _Bridgel2.contract, event: "MigrateLegacyToken", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event MigrateLegacyToken(address sender, address legacyTokenAddress, address updatedTokenAddress, uint256 amount)
func (_Bridgel2 *Bridgel2Filterer) WatchMigrateLegacyToken(opts *bind.WatchOpts, sink chan<- *Bridgel2MigrateLegacyToken) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "MigrateLegacyToken")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2MigrateLegacyToken)
				if err := _Bridgel2.contract.UnpackLog(event, "MigrateLegacyToken", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MigrateLegacyToken(address sender, address legacyTokenAddress, address updatedTokenAddress, uint256 amount)
func (_Bridgel2 *Bridgel2Filterer) ParseMigrateLegacyToken(log types.Log) (*Bridgel2MigrateLegacyToken, error) {
	event := new(Bridgel2MigrateLegacyToken)
	if err := _Bridgel2.contract.UnpackLog(event, "MigrateLegacyToken", log); err != nil {
		return nil, err
	}
...
// Bridgel2NewWrappedTokenIterator is returned from FilterNewWrappedToken and is used to iterate over the raw logs and unpacked data for NewWrappedToken events raised by the Bridgel2 contract.
type Bridgel2NewWrappedTokenIterator struct {
	Event *Bridgel2NewWrappedToken // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2NewWrappedTokenIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2NewWrappedToken)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2NewWrappedTokenIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2NewWrappedTokenIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2NewWrappedToken represents a NewWrappedToken event raised by the Bridgel2 contract.
type Bridgel2NewWrappedToken struct {
	OriginNetwork       uint32
	OriginTokenAddress  common.Address
...
func (_Bridgel2 *Bridgel2Filterer) FilterNewWrappedToken(opts *bind.FilterOpts) (*Bridgel2NewWrappedTokenIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "NewWrappedToken")
	if err != nil {
		return nil, err
	}
	return &Bridgel2NewWrappedTokenIterator{contract: _Bridgel2.contract, event: "NewWrappedToken", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event NewWrappedToken(uint32 originNetwork, address originTokenAddress, address wrappedTokenAddress, bytes metadata)
func (_Bridgel2 *Bridgel2Filterer) WatchNewWrappedToken(opts *bind.WatchOpts, sink chan<- *Bridgel2NewWrappedToken) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "NewWrappedToken")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2NewWrappedToken)
				if err := _Bridgel2.contract.UnpackLog(event, "NewWrappedToken", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event NewWrappedToken(uint32 originNetwork, address originTokenAddress, address wrappedTokenAddress, bytes metadata)
func (_Bridgel2 *Bridgel2Filterer) ParseNewWrappedToken(log types.Log) (*Bridgel2NewWrappedToken, error) {
	event := new(Bridgel2NewWrappedToken)
	if err := _Bridgel2.contract.UnpackLog(event, "NewWrappedToken", log); err != nil {
		return nil, err
	}
...
// Bridgel2RemoveSovereignTokenAddressIterator is returned from FilterRemoveSovereignTokenAddress and is used to iterate over the raw logs and unpacked data for RemoveSovereignTokenAddress events raised by the Bridgel2 contract.
type Bridgel2RemoveSovereignTokenAddressIterator struct {
	Event *Bridgel2RemoveSovereignTokenAddress // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2RemoveSovereignTokenAddressIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2RemoveSovereignTokenAddress)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2RemoveSovereignTokenAddressIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2RemoveSovereignTokenAddressIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2RemoveSovereignTokenAddress represents a RemoveSovereignTokenAddress event raised by the Bridgel2 contract.
type Bridgel2RemoveSovereignTokenAddress struct {
	SovereignTokenAddress common.Address
	Raw                   types.Log // Blockchain specific contextual infos
}
...
func (_Bridgel2 *Bridgel2Filterer) FilterRemoveSovereignTokenAddress(opts *bind.FilterOpts) (*Bridgel2RemoveSovereignTokenAddressIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "RemoveSovereignTokenAddress")
	if err != nil {
		return nil, err
	}
	return &Bridgel2RemoveSovereignTokenAddressIterator{contract: _Bridgel2.contract, event: "RemoveSovereignTokenAddress", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event RemoveSovereignTokenAddress(address sovereignTokenAddress)
func (_Bridgel2 *Bridgel2Filterer) WatchRemoveSovereignTokenAddress(opts *bind.WatchOpts, sink chan<- *Bridgel2RemoveSovereignTokenAddress) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "RemoveSovereignTokenAddress")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2RemoveSovereignTokenAddress)
				if err := _Bridgel2.contract.UnpackLog(event, "RemoveSovereignTokenAddress", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event RemoveSovereignTokenAddress(address sovereignTokenAddress)
func (_Bridgel2 *Bridgel2Filterer) ParseRemoveSovereignTokenAddress(log types.Log) (*Bridgel2RemoveSovereignTokenAddress, error) {
	event := new(Bridgel2RemoveSovereignTokenAddress)
	if err := _Bridgel2.contract.UnpackLog(event, "RemoveSovereignTokenAddress", log); err != nil {
		return nil, err
	}
...
// Bridgel2SetSovereignTokenAddressIterator is returned from FilterSetSovereignTokenAddress and is used to iterate over the raw logs and unpacked data for SetSovereignTokenAddress events raised by the Bridgel2 contract.
type Bridgel2SetSovereignTokenAddressIterator struct {
	Event *Bridgel2SetSovereignTokenAddress // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2SetSovereignTokenAddressIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2SetSovereignTokenAddress)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2SetSovereignTokenAddressIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2SetSovereignTokenAddressIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2SetSovereignTokenAddress represents a SetSovereignTokenAddress event raised by the Bridgel2 contract.
type Bridgel2SetSovereignTokenAddress struct {
	OriginNetwork         uint32
	OriginTokenAddress    common.Address
	SovereignTokenAddress common.Address
	IsNotMintable         bool
...
func (_Bridgel2 *Bridgel2Filterer) FilterSetSovereignTokenAddress(opts *bind.FilterOpts) (*Bridgel2SetSovereignTokenAddressIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "SetSovereignTokenAddress")
	if err != nil {
		return nil, err
	}
	return &Bridgel2SetSovereignTokenAddressIterator{contract: _Bridgel2.contract, event: "SetSovereignTokenAddress", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SetSovereignTokenAddress(uint32 originNetwork, address originTokenAddress, address sovereignTokenAddress, bool isNotMintable)
func (_Bridgel2 *Bridgel2Filterer) WatchSetSovereignTokenAddress(opts *bind.WatchOpts, sink chan<- *Bridgel2SetSovereignTokenAddress) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "SetSovereignTokenAddress")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2SetSovereignTokenAddress)
				if err := _Bridgel2.contract.UnpackLog(event, "SetSovereignTokenAddress", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SetSovereignTokenAddress(uint32 originNetwork, address originTokenAddress, address sovereignTokenAddress, bool isNotMintable)
func (_Bridgel2 *Bridgel2Filterer) ParseSetSovereignTokenAddress(log types.Log) (*Bridgel2SetSovereignTokenAddress, error) {
	event := new(Bridgel2SetSovereignTokenAddress)
	if err := _Bridgel2.contract.UnpackLog(event, "SetSovereignTokenAddress", log); err != nil {
		return nil, err
	}
...
// Bridgel2SetSovereignWETHAddressIterator is returned from FilterSetSovereignWETHAddress and is used to iterate over the raw logs and unpacked data for SetSovereignWETHAddress events raised by the Bridgel2 contract.
type Bridgel2SetSovereignWETHAddressIterator struct {
	Event *Bridgel2SetSovereignWETHAddress // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Bridgel2SetSovereignWETHAddressIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(Bridgel2SetSovereignWETHAddress)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Bridgel2SetSovereignWETHAddressIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Bridgel2SetSovereignWETHAddressIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Bridgel2SetSovereignWETHAddress represents a SetSovereignWETHAddress event raised by the Bridgel2 contract.
type Bridgel2SetSovereignWETHAddress struct {
...
func (_Bridgel2 *Bridgel2Filterer) FilterSetSovereignWETHAddress(opts *bind.FilterOpts) (*Bridgel2SetSovereignWETHAddressIterator, error) {

	logs, sub, err := _Bridgel2.contract.FilterLogs(opts, "SetSovereignWETHAddress")
	if err != nil {
		return nil, err
	}
	return &Bridgel2SetSovereignWETHAddressIterator{contract: _Bridgel2.contract, event: "SetSovereignWETHAddress", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SetSovereignWETHAddress(address sovereignWETHTokenAddress, bool isNotMintable)
func (_Bridgel2 *Bridgel2Filterer) WatchSetSovereignWETHAddress(opts *bind.WatchOpts, sink chan<- *Bridgel2SetSovereignWETHAddress) (event.Subscription, error) {

	logs, sub, err := _Bridgel2.contract.WatchLogs(opts, "SetSovereignWETHAddress")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Bridgel2SetSovereignWETHAddress)
				if err := _Bridgel2.contract.UnpackLog(event, "SetSovereignWETHAddress", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SetSovereignWETHAddress(address sovereignWETHTokenAddress, bool isNotMintable)
func (_Bridgel2 *Bridgel2Filterer) ParseSetSovereignWETHAddress(log types.Log) (*Bridgel2SetSovereignWETHAddress, error) {
	event := new(Bridgel2SetSovereignWETHAddress)
	if err := _Bridgel2.contract.UnpackLog(event, "SetSovereignWETHAddress", log); err != nil {
		return nil, err
	}
